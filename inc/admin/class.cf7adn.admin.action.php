 ...
 *
 * @package WordPress
 * @subpackage Contact Form 7 - Authorize.Net
 * @since 1.0
 */
														...
														echo '<tr class="inside-field">' .
															...
															'<td>' .
																(
																	...
																	? '<a href="' . esc_url( home_url( str_replace( $root_path, '/', $attachment[$key] ) ) ) . '" target="_blank" download>' . __( sprintf( '%s', $value ), 'contact-form-7-authorize-net-addon' ) . '</a>'
